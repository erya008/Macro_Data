...
#-------------------------------------------------User Inputs
vintage      = '2022-04-28'                                                   # vintage dataset to use for estimation
...
Spec = load_spec('Spec_CN_example.xls')
...
#-------------------------------------------------Plot data
# Raw vs transformed
idxSeries = np.where(Spec.SeriesID == "consumption")[0][0]
